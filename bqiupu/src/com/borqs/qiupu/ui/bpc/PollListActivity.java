...
public class PollListActivity extends BasicNavigationActivity {
...
//    private Spinner mSpinner;
    ...
    private PollListFragment mPollListFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.poll_fragment_activity);
        mPollListFragment = (PollListFragment)getSupportFragmentManager().findFragmentById(R.id.poll_fragment);
...
//                    }
                ...
                case SYNC_POLL_END: {
                    mPollListFragment.syncPollEnd(msg.getData().getBoolean(RESULT), mHandler);
...
//                break;
//        }
        mPollListFragment.onActivityResult(requestCode, resultCode, data);
...
//    }
    ...
    public void onPollFetchOk() {
        Message msg = mHandler.obtainMessage(SYNC_POLL_END);
        msg.getData().putBoolean(RESULT, true);
        msg.sendToTarget();
    }

    public void onPollFetchFailed() {
        Message msg = mHandler.obtainMessage(SYNC_POLL_END);
        msg.getData().putBoolean(RESULT, false);
        msg.sendToTarget();
    }
