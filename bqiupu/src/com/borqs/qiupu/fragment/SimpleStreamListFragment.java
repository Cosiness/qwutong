...
import com.borqs.wutong.BaseActivity;
...
public class SimpleStreamListFragment extends AbstractStreamListFragment implements
        OlderPostsLoader,
        RefreshPostListener,
    ...
    public SimpleStreamListFragment() {
        super();
    }
    ...
    public void filterStream() {
        if (isFilterNeeded()) {
            BpcPostsFilterActivity.startActivityForResult(getActivity(), mMetaData.mSourceFilter, mMetaData.mSourceAppKey,
                    mFilterType, BaseActivity.REQUEST_CODE_STREAM_FILTER);
        } else {
